...
final List<Tool> tools = [
  ...
  Tool(name: 'Git & GitHub', iconPath: 'assets/tools/github_logo.png'),
  
  Tool(name: 'Docker', iconPath: 'assets/tools/docker_logo.png'),
  Tool(name: 'Codemagic', iconPath: 'assets/tools/codemagic_logo.png'),
  Tool(name: 'Postman', iconPath: 'assets/tools/postman_logo.png'),
